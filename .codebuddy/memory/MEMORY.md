...
- **venv** = `backend/.venv`（Python 3.12）；**pytest 基线 = 274**（2026-09-17；沿革 237 → 251（`Task-015`/`016`）→ 257（`Task-018`）→ 265（`Task-019`）→ 267（`Task-021`）→ 273（`Task-022` +6）→ **274**（`Task-023` 验收补强 +1））；端口统一 **8010**（8000 被 `wslrelay.exe` 常占）。
