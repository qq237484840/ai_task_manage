...
| 实体 | 关键属性（草案） |
| --- | --- |
| DATA-001 作业任务 | 任务ID/家庭ID/标题/学科/年级/题目集合(序号/题干/学科/题型[主观|客观]/参考答案-客观题可选[ADR-006])/状态/发布时间/截止时间/关联学生档案 |
...
| DATA-004 识别结果 | 识别ID/提交ID/题目级或整页结构(题号/题目/作答/过程)/置信度/模型信息 |
| DATA-005 匹配结果 | 匹配ID/提交ID/任务ID/对齐关系(题号↔题目)/依据/状态 |
| DATA-006 质量评价 | 评价ID/提交ID/六维度分+权重版本/综合分/依据/置信度/规则版本 |
