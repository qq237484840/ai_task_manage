...
>
> 状态：**V1 启用，M001 Frozen / M002 Frozen 已登记**（2026-09-08）。API-M001-001~012 **Frozen**（修改须走 CR；M001 变更 `CR-001`/`ACR-001`/`CR-002`/`ACR-002` 均 **Approved**，合并 CHANGE 执行中）；API-M002-001~006 **Frozen**（契约基线 **v0.3.0**，2026-09-08 用户批准；先采后认重构 + 内容级判定口径；v0.1.0 四接口语义废弃）；M003~M007 在各自契约阶段逐条登记；登记前不得实现无契约接口。
